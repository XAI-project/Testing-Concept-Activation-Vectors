...
SOCCER_BALL_TRAIN_PATH = BALLS_TRAIN_PATH + "/soccer ball"
SOCCER_BALL_TEST_PATH = BALLS_TEST_PATH + "/soccer ball"
SOCCER_BALL_VALID_PATH = BALLS_VALID_PATH + "/soccer ball"
