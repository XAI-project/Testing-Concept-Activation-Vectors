...
class Network(nn.Module):
    ...
    def forward_and_save_layers(self, input):
        ...
        self.output1 = F.relu(self.bn1(self.conv1(input)))
        # image dim: 12 x 30 x 30

        self.output2 = F.relu(self.bn2(self.conv2(self.output1)))
        # image dim: 12 x 28 x 28

        self.output3 = self.pool(self.output2)
        # image dim: 12 x 14 x 14

        self.output4 = F.relu(self.bn4(self.conv4(self.output3)))
        # image dim: 24 x 12 x 12
